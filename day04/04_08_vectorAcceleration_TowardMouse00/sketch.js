// 04_04_vectorAcceleration_TowardsMouse00
...
function draw() {
    ...
    mover.acceleration = p5.Vector.mult( p5.Vector.random2D(), 2 );
    mover.update();
    mover.checkEdges();
    mover.draw();
    ...
    // use direction to draw a line
    // that represents the direction and magnitude
    // from mouse to mover
    push();
